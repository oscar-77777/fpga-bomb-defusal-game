...
`timescale 1 ps / 1 ps
module ADC_ADC_avalon_st_adapter #(
	...
	ADC_ADC_avalon_st_adapter_data_format_adapter_0 data_format_adapter_0 (
	...
	ADC_ADC_avalon_st_adapter_timing_adapter_0 timing_adapter_0 (
		.clk               (in_clk_0_clk),                       //   clk.clk
		.reset_n           (~in_rst_0_reset),                    // reset.reset_n
	...
	ADC_ADC_avalon_st_adapter_timing_adapter_1 timing_adapter_1 (
		.clk               (in_clk_0_clk),                            //   clk.clk
		.reset_n           (~in_rst_0_reset),                         // reset.reset_n
